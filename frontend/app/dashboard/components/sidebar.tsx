...
export default function Sidebar() {
    ...
    return (
        <div className='flex flex-col gap-6 p-4'>
            <Button id="tour-add-mt5" variant="outline" className="w-full justify-between h-12 rounded-full border-gray-200 hover:bg-gray-50 hover:text-gray-900" onClick={() => setMt5modal(true)}>
            ...
            <Card id="tour-portfolio-summary" className="bg-blue-50/50 border-none shadow-none">
                <CardHeader className="pb-2">
